...
#For y~x2:
R2_x2_text <- as.data.frame(matrix(NA, nrow=9, ncol=3))
colnames(R2_x2_text) <- c('measure', 'method', 'r2')
R2_x2_text$measure <- c(rep('Richness',3),rep("Shannon's Diversity", 3),rep("Simpson's Dominance",3))
R2_x2_text$method <- rep(unique(compare_subsampling$method),3)
R2_x2_text$r2 <- c(sprintf("%.3f", R2_summary['5 collections/formation', 'R2.richness.x2']),
...
#1bii - make figures 
effort_richness_x2 <- ggplot(data=subset(compare_subsampling, !(is.na(HedgesG_genrich)))) +
  ...
  geom_text(data=subset(R2_x2_text, measure=='Richness'), x=-3, y=2.4, hjust=0, aes(label=paste0("R^2~'='~", r2)), parse = TRUE) +
...
effort_diversity_x2 <- ggplot(data=subset(compare_subsampling, !(is.na(HedgesG_H)))) +
  ...
  geom_point(aes(x=sampling_difference_colls, y=HedgesG_H, 
                 fill=method, shape=method), size=2, colour='black') +
  geom_text(data=subset(R2_x2_text, measure=="Shannon's Diversity"), x=-3, y=2.1, hjust=0, aes(label=paste0("R^2~'='~", r2)), parse = TRUE) +
  facet_wrap(vars(method)) +
  scale_fill_manual(values=compare.cols) +
  scale_shape_manual(values=compare.shapes) +
  scale_color_manual(values=compare.cols) +
...
#for y~x:
R2_x1_text <- as.data.frame(matrix(NA, nrow=9, ncol=3))
colnames(R2_x1_text) <- c('measure', 'method', 'r2')
R2_x1_text$measure <- c(rep('Richness',3),rep("Shannon's Diversity", 3),rep("Simpson's Dominance",3))
R2_x1_text$method <- rep(unique(compare_subsampling$method),3)
R2_x1_text$r2 <- c(sprintf("%.3f", R2_summary['5 collections/formation', 'R2.richness.x1']),
...
#1bii - make figures 
effort_richness_x1 <- ggplot(data=subset(compare_subsampling, !(is.na(HedgesG_genrich)))) +
  geom_smooth(aes(x=sampling_difference_colls, y=HedgesG_genrich,
                  fill=method, color=method), 
              method='lm', 
  ) +
  ...
  geom_point(aes(x=sampling_difference_colls, y=HedgesG_genrich, 
                 fill=method, shape=method), size=2, colour='black') +
  geom_text(data=subset(R2_x1_text, measure=='Richness'), x=-3, y=2.4, hjust=0, aes(label=paste0("R^2~'='~", r2)), parse = TRUE) +
  facet_wrap(vars(method)) +
  scale_fill_manual(values=compare.cols) +
  scale_shape_manual(values=compare.shapes) +
  scale_color_manual(values=compare.cols) +
...
effort_diversity_x1 <- ggplot(data=subset(compare_subsampling, !(is.na(HedgesG_H)))) +
  geom_smooth(aes(x=sampling_difference_colls, y=HedgesG_H,
                  fill=method, color=method), 
              method='lm', 
  ) +
  ...
  geom_point(aes(x=sampling_difference_colls, y=HedgesG_H, 
                 fill=method, shape=method), size=2, colour='black') +
  geom_text(data=subset(R2_x1_text, measure=="Shannon's Diversity"), x=-3, y=2.1, hjust=0, aes(label=paste0("R^2~'='~", r2)), parse = TRUE) +
  facet_wrap(vars(method)) +
  scale_fill_manual(values=compare.cols) +
  scale_shape_manual(values=compare.shapes) +
  scale_color_manual(values=compare.cols) +
...
FigureS6 <- ggarrange2(effort_diversity_x1, effort_diversity_x2, ncol=1)
