...
all_deep_data <- subset(all_data, lith=='carbonate')
...
#Save results 
reefs_carbonate_results_df <- results_df
save(reefs_carbonate_results_df, file='supplemental_effectsize_reefs_carbonate.RData')
