...
all_data$palaeoenvironment <- rep(NA, nrow(all_data))
all_data[which(all_data$lith=='siliciclastic' & all_data$bath=='shallow'),'palaeoenvironment'] <- 'shallow_siliciclastic'
all_data[which(all_data$lith=='siliciclastic' & all_data$bath=='deep'),'palaeoenvironment'] <- 'deep_siliciclastic'
all_data[which(all_data$lith=='siliciclastic' & all_data$bath=='unknown'),'palaeoenvironment'] <- 'unclass_siliciclastic'
all_data[which(all_data$lith=='carbonate' & all_data$bath=='shallow'),'palaeoenvironment'] <- 'shallow_carbonate'
all_data[which(all_data$lith=='carbonate' & all_data$bath=='deep'),'palaeoenvironment'] <- 'deep_carbonate'
all_data[which(all_data$lith=='carbonate' & all_data$bath=='unknown'),'palaeoenvironment'] <- 'unclass_carbonate'
table(all_data$palaeoenvironment)

#subset only siliciclastic data
all_deep_data <- subset(all_data, lith=='siliciclastic')
...
#Save results 
reefs_siliciclastic_results_df <- results_df
save(reefs_siliciclastic_results_df, file='supplemental_effectsize_reefs_siliciclastic.RData')
