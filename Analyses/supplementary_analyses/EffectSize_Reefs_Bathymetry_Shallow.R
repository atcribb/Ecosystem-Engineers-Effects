...
all_deep_data <- subset(all_data, bath=='shallow')
...
#Save results 
reefs_shallow_results_df <- results_df
save(reefs_shallow_results_df, file='supplemental_effectsize_reefs_shallow.RData')
