...
#Summary: Reef-builders effect size with grid-area spatial subsampling
...
ecoeng_genera <- unique(all_reef_builders$genus) #get each ecosystem engineering genus name
ecoeng_formations <- unique(all_reef_builders$formation) #get each formation name containing ecosystem engineers
...
reefbuilders_spatial_results_df <- results_df
save(reefbuilders_spatial_results_df, file='Output/reefbuilders_spatialsubsample.RData')
